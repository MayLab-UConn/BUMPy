...
folder="reading_grofile_test_files"

rm $folder/*.tpr $folder/*.gro $folder/test*

python3 ../../bumpy.py -f asymm.gro -s sphere -z 10.5 -o $folder/test_start.pdb -p $folder/test_start.top -n $folder/test_start.ndx -g r_sphere:100
