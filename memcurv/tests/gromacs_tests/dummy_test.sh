...
python3 ../../main.py -f asymm.pdb -s sphere -z 10.5 -o $folder/test_start.pdb -p $folder/test_start.top -n $folder/test_start.ndx   --dummy_grid_thickness 50 -g r_sphere:100   --gen_dummy_particles
