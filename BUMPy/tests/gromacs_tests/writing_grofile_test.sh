...
folder="writing_grofile_test_files"

rm $folder/*.tpr $folder/*.gro $folder/test*

python3 ../../bumpy.py -f asymm.pdb -s sphere -z 10.5 -o $folder/test_start.gro -p $folder/test_start.top -n $folder/test_start.ndx -g r_sphere:100
...
gmx grompp -f $folder/step6.0_equilibration.mdp -p $folder/test_start.top -n $folder/test_start.ndx -c $folder/test_start.gro -o $folder/test_minimization.tpr
